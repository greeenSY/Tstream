...
CONF_DIR = os.path.expanduser("~/.tstream")
...
def nimbus():
    ...
    exec_storm_class(
        "org.act.tstream.daemon.nimbus.NimbusServer", 
        jvmtype="-server", 
...
def supervisor():
    ...
    exec_storm_class(
        "org.act.tstream.daemon.supervisor.Supervisor", 
        jvmtype="-server", 
        extrajars=cppaths, 
        childopts=childopts)
